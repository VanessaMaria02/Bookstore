...
function setNavbar(userDaten){
    ...
    if(role === "admin"){
        ...
        $("#navbar").append('<li class="nav-item"><a class="nav-link" href="produkte.php">Produkte</a></li><li class="nav-item"><li class="nav-item"><a class="nav-link" href="meinKonto.php">Mein Konto</a></li><li class="nav-item"><a class="nav-link" href="logout.php">Logout</a></li>');
        $("nav").append(" <p class='fs-6 text-end'> Willkommen, "+uname+" </p>");
    }else{
